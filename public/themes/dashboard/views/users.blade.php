                                ...
                                echo '<td class="center">
                                    ...
                                    if($suspended = $throttle->isSuspended())
                                    {
                                       echo '<a class="btn btn-success" href="/user/'.$user->id.'/unsuspend">
                                        <i class="icon icon-unlocked icon-white"></i> Unsuspend</a>&nbsp;';
                                    }
                                    else
                                    {
                                        echo '<a class="btn btn-warning" href="/user/'.$user->id.'/suspend">
                                        <i class="icon icon-locked icon-white"></i> Suspend</a>&nbsp;';
                                    }
                                    if($banned = $throttle->isBanned())
                                    {
                                       echo '<a class="btn btn-warning" href="/user/'.$user->id.'/unban">
                                        <i class="icon icon-unlocked icon-white"></i> Unban</a>&nbsp;';
                                    }
                                    else
                                    {
                                        echo '<a class="btn btn-danger" href="/user/'.$user->id.'/ban">
                                        <i class="icon icon-locked icon-white"></i> Ban</a>&nbsp;';
                                    }
                                    echo '<a class="btn btn-danger" href="/user/'.$user->id.'/delete">
