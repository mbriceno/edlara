                        ...
                        <div class="row-fluid">
                            ...
                            foreach($examdata['questiondata']['questions'] as $question){
                                ...
                                echo '<div id="examdata"><label for="examdata">MCQ Question '.$qc.'</label>
                                    <input id="examdata" name="question_'.$qc.'" placeholder="Place the MCQ Question '.$qc.' Here" type="text" value="'.Input::old('question_'.$qc,$question).'" style="width:50%;" required><br>&nbsp;<br>&nbsp;
                            
                               <div id="uniform-examdata" class="checker"><span><input style="opacity: 0;" id="examdata" name="checkbox_'.$qc.'[]" value="1" type="checkbox" '.$checked1.'></span></div>
                               <input name="checkbox_'.$qc.'_1" placeholder="Place the Choice 1 here" type="text" value="'.Input::old('checkbox_'.$qc.'_1',$examdata['questiondata']['question'][$qc]['checkboxdata'][1]).'" required>
                            
                               <div id="uniform-examdata" class="checker"><span><input style="opacity: 0;" id="examdata" name="checkbox_'.$qc.'[]" value="2" type="checkbox" '.$checked2.'></span></div>
                                <input name="checkbox_'.$qc.'_2" placeholder="Place the Choice 2 here" type="text" value="'.Input::old('checkbox_'.$qc.'_2',$examdata['questiondata']['question'][$qc]['checkboxdata'][2]).'" required>
                            
                                <div id="uniform-examdata" class="checker"><span><input style="opacity: 0;" id="examdata" name="checkbox_'.$qc.'[]" value="3" type="checkbox" '.$checked3.'></span></div>
                                <input name="checkbox_'.$qc.'_3" placeholder="Place the Choice 3 here" type="text" value="'.Input::old('checkbox_'.$qc.'_3',$examdata['questiondata']['question'][$qc]['checkboxdata'][3]).'" required>
                            
                                <div id="uniform-examdata" class="checker"><span><input style="opacity: 0;" id="examdata" name="checkbox_'.$qc.'[]" value="4" type="checkbox"  '.$checked4.'></span></div>
                                <input name="checkbox_'.$qc.'_4" placeholder="Place the Choice 4 here" type="text" value="'.Input::old('checkbox_'.$qc.'_4',$examdata['questiondata']['question'][$qc]['checkboxdata'][4]).'" required><br>&nbsp;<br>&nbsp;';
                            if($qc >= 6){
                                echo '<a href="#" id="removeMCQ">Remove</a>';
                            }
                            echo   '<br><input name="checkbox_'.$qc.'[]" value="0" type="hidden"></div>';
